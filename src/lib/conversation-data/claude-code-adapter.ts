...
import type { ClaudeCodeSessionSummary, ClaudeCodeSessionTranscript } from '../claude-code-exporter-types';
import { resolveClaudeCodeProjectsDir } from '../claude-code-exporter-types';
...
import { claudeCodeTranscriptToMessages } from './claude-code-messages';
...
const buildConversation = async (
    ...
    const transcript = options.includeMessages
        ...
        : null;
    const allMessages = transcript ? claudeCodeTranscriptToMessages(transcript) : [];
