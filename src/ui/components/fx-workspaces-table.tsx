import type { FxWorkspaceGroup } from '@spiracha/lib/fx-exporter-types';
import { Link } from '@tanstack/react-router';
import { DataTable } from '#/components/data-table';
import { createDataTableColumnHelper } from '#/lib/data-table-config';
import { formatDateTime, formatNumber } from '#/lib/formatters';

type FxWorkspacesTableProps = { workspaces: FxWorkspaceGroup[] };
const columnHelper = createDataTableColumnHelper<FxWorkspaceGroup>();
...
export const FxWorkspacesTable = ({ workspaces }: FxWorkspacesTableProps) => (
    <DataTable columns={columns} data={workspaces} emptyMessage="No FX workspaces match the current search." />
);
