...
export const ClineWorkspacesTable = ({ workspaces }: { workspaces: ClineWorkspaceGroup[] }) => (
    <DataTable columns={columns} data={workspaces} emptyMessage="No Cline workspaces match the current search." />
);
