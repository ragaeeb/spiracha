...
export const Route = createRootRouteWithContext<RouterContext>()({
    ...
    head: () => ({
        ...
        meta: [
            ...
            {
                content:
                    'Browse local Codex, Claude Code, Command Code, Grok, Grok Bot, Kiro, Qoder, Cursor, Antigravity, FX, MiniMax Code, and OpenCode history through a compact workspace UI.',
                name: 'description',
            },
            {
                title: 'Spiracha UI',
